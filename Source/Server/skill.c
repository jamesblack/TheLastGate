...
struct metaStat metaStats[102] = {
	...
	{ 0, 0, "", "", "" }, // blank
	{ 0, 9, "  Active Stats:",      "",        "" }, // 23
	{ 1, 5, "Cleave Hit Damage",    "",        "Damage dealt by your Cleave skill, before reduction from target Parry Score and Armor Value. Surrounding targets take 3/4 of this value." },
	...
	{ 1, 1, "Leap Hit Damage",      "",        "Damage dealt by your Leap skill if your target is at or near maximum hitpoints." },
	...
	{ 1, 4, "Blast Hit Damage",     "",        "Damage dealt by your Blast spell, before reduction from target Immunity and Armor Value. Surrounding targets take 3/4 of this value." },
	...
	{ 0, 1, "Pulse Hit Damage",     "/tick",   "Damage dealt by the Pulse spell to surrounding enemies when pulsing, before reduction from target Immunity and Armor Value." },
	...
	{ 1, 6, "Zephyr Hit Damage",    "",        "Damage granted by your Zephyr spell, before reduction from target Parry Score and Armor Value. This occurs one second after a successful hit." },
	...
	{ 1, 1, "Pulse Hit Heal",       "/tick",   "Healing caused by the Pulse spell to surrounding allies when pulsing." },
